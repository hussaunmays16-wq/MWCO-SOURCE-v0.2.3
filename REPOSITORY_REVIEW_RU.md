...
> 📄 Дополнительно: официальные патчноуты релизов **v0.2.4 → v0.3.2** (перевод) и их сопоставление с кодом v0.2.3 в этом репозитории — [RELEASE_NOTES_RU.md](RELEASE_NOTES_RU.md).
